       ...
       <div class="container-fluid ">
         ...
         <div class="collapse navbar-collapse" id="navbarScroll">
           <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
             <li class="nav-item">
               <a class="nav-link active   text-light  rounded" aria-current="page" href=".">HOME</a>
             </li>
             <li class="nav-item">
             ...
             <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                 <li><a class="dropdown-item" href="?m=pi" title="pengenalan internet">Jarkom</a></li>
                 <li><a class="dropdown-item" href="?m=wi" title="pengenalan wifi">server</a></li>
                 <li><hr class="dropdown-divider"></li>
                 <li><a class="dropdown-item " href="?m=vidio1">Course-online</a></li>
             ...
             <li class="nav-item">
               <a class="nav-link disabled text-light" href="m=vidieo" tabindex="-1" aria-disabled="true">VIDEO</a>
             </li>
           </ul>
           <form class="d-flex">
